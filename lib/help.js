...
var Help =
{
  ...
  Global: function()
  {
    ...
    var keys = Object.keys(Commands.list);
  ...
  Specific: function(command)
  {
    ...
    if(typeof Commands.list[command] === 'undefined'){ return Display.error('Unknow command "' + command + '"'); }

    //Get the command object
    var obj = Commands.list[command];
